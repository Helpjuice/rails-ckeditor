class CreateCkeditorAssets < ActiveRecord::Migration
  def self.up
    ...
    add_index "ckeditor_assets", ["assetable_id", "assetable_type", "type"], :name => "ndx_type_assetable"
		...
		add_index "ckeditor_assets", ["account_id", "assetable_type", "assetable_id"], :name => "assets_account_type_assetable_id"
		add_index :ckeditor_assets, :account_id, :name => "fk_account"
  end
